...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-4 items col-xs-12">
    <img src="img/food/beef.jpg" alt="309" style="width:100%; height: 100%;" class="img-responsive gallery image1">
      <div class="mid">
          <a href="#"><div class="text-1" style="text-align: center;"><i>Beef burger with fries in just <br/>Rs. 150<br/><b>Order Now</b></i></div></a>
        </div>
    </div>
...
<div class="container">
 <div id="map">
    <script>
      function initMap() {
        var uluru = {lat: 33.64175882, lng: 72.98908442};
