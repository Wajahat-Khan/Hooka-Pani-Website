...
<html>
    ...
    <title>Author Info | Library.com</title>
    </head>
    <body>
    ...
    <div id="primaryContainer" class="primaryContainer clearfix">
        ...
        <table align="center" width="100%">
          ...
          <tr>
            ...
            <td><?php echo $row_AuthorQuery['AuthorID']; ?></td>
          </tr>
          <tr>
            <td><strong>Name:</strong></td>
            <td><?php echo $row_AuthorQuery['Author_Name']; ?></td>
          </tr>
          <tr>
            <td><strong>Address:</strong></td>
            <td><?php echo $row_AuthorQuery['Address']; ?></td>
          </tr>
          <tr>
            <td><strong>Qualification:</strong></td>
            <td><?php echo $row_AuthorQuery['Qualification']; ?></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
