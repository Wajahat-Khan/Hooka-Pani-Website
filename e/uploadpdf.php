...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE Books SET BookNameID=('$_name') WHERE ID=%s",
                       GetSQLValueString($_POST['ID'], "int"));

  mysql_select_db($database_BooksLib, $BooksLib);
  $Result1 = mysql_query($updateSQL, $BooksLib) or die(mysql_error());

  $updateGoTo = "bookdetail.php?ID=" . $row_Recordset1['ID'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_BooksLib, $BooksLib);
$query_Recordset1 = sprintf("SELECT ID, BookNameID FROM Books WHERE ID = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<html>
    ...
    <div id="primaryContainer" class="primaryContainer clearfix">
        ...
        <div id="form">
        <p id="text1">Upload Book (PDF)</p> <br/>
        <div class="center">
        <br/>
