...
<html>
    ...
    <title>Category Info | Library.com</title>
    </head>
    <body>
    ...
    <div id="primaryContainer" class="primaryContainer clearfix">
        ...
        <table align="center" width="100%">
          ...
          <tr>
            ...
            <td><?php echo $row_AuthorQuery['CategoryID']; ?></td>
          </tr>
          <tr>
            <td><strong>Name:</strong></td>
            <td><?php echo $row_AuthorQuery['Category_Name']; ?></td>
          </tr>
