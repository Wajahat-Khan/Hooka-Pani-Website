...
$colname_gendra = "-1";
if (isset($_POST['gendra'])) {
  $colname_gendra = $_POST['gendra'];
}
mysql_select_db($database_BooksLib, $BooksLib);
$query_gendra = sprintf("SELECT * FROM QUERY_V_RECORD WHERE Category_Name = %s ORDER BY Category_Name ASC", GetSQLValueString($colname_gendra, "text"));
$gendra = mysql_query($query_gendra, $BooksLib) or die(mysql_error());
$row_gendra = mysql_fetch_assoc($gendra);
$totalRows_gendra = mysql_num_rows($gendra);
?>
<!DOCTYPE html>
<html> 
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Genres | Library.com</title>
...
<div class="container">
  ...
  <div class="main">
      ...
      <?php do { ?>
        <?php if ($totalRows_gendra > 0) { // Show if recordset not empty ?>
  <table width="0" border="0" align="center"">
    <tr>
      <td align="center" width="150px" height="200px"><img width="150px" height="200px"src="images/<?php echo $row_gendra['Book_Img']; ?>"></td>
      <td align="center" width="200px"> <?php echo $row_gendra['BookName']; ?> | <?php echo $row_gendra['Author_Name']; ?></td>
      <td align="center" width="300px">Review Goes Here</td>
      <td align="center" width="150px"><a href="bookdetail.php?ID=<?php echo $row_gendra['BookID']; ?>">Read Book</a></td>
      <strong></strong></tr>
  </table>
  <?php } // Show if recordset not empty ?>
        <?php } while ($row_gendra = mysql_fetch_assoc($gendra)); ?>
  	</div>
  </div>
  <div class="formsbase">
    <div class="SearchA">
