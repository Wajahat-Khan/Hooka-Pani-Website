...
$user = mysql_query($query_user, $BooksLib) or die(mysql_error());
...
<html>
    ...
    <div id="primaryContainer" class="primaryContainer clearfix">
        ...
        <div id="form">
        <p id="text1">Details</p> <br/>
        
        <div id="detailcontenet">
            <h2>Main Slide Show:
            </h2>
            <p>Image Size: 830 X 360<br>
              Format:  cover_n.jpg                where n = number of slide<br>
              Total picture number: 5 (Five)     where n = 1, 2, 3, 4, 5</p>
            <h2>Favicon Name:</h2>
            <p>Name: favicon.icon          </p>
        </div>
