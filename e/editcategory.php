...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "editcategory")) {
  $updateSQL = sprintf("UPDATE CATEGORY SET Category_Name=%s WHERE CategoryID=%s",
  ...
  $updateGoTo = "addcategory.php?ID=" . $row_AuthorQuery['CategoryID'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_BooksLib, $BooksLib);
$query_AuthorQuery = sprintf("SELECT * FROM CATEGORY WHERE CategoryID = %s", GetSQLValueString($colname_AuthorQuery, "int"));
...
<html>
    ...
    <div id="primaryContainer" class="primaryContainer clearfix">
        ...
        <div id="form">
        <p id="text1">Edit Category: <?php echo $row_AuthorQuery['Category_Name']; ?></p> 
        <br/>
        <br/>
        
        <form action="<?php echo $editFormAction; ?>" name="editcategory" method="POST" id="editcategory">
        <input name="idhidden" type="hidden">
        <table align="center" width="800px">
          <tr>
            <th width="250" scope="row">Category ID:</th>
            <td><input name="categoryid" type="text" class="btn" value="<?php echo $row_AuthorQuery['CategoryID']; ?>"></td>
          </tr>
          <tr>
            <th scope="row">Category Name:</th>
            <td><input name="categoryname" type="text" class="btn" value="<?php echo $row_AuthorQuery['Category_Name']; ?>"></td>
          </tr>
        ...
        <input type="hidden" name="MM_update" value="editcategory">
        </form>
        <br />
        <div class="center3">
        <ul>
              <li><a href="addcategory.php">Back</a></li>
              <li><a href="addcategory.php?ID=<?php echo $row_AuthorQuery['CategoryID']; ?>">Next</a></li>
        </ul>
            </div>
        </div>
