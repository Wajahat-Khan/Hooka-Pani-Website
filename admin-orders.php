...
?>
<?php  
if(isset($_POST["orders_edit_direct"])){
  header('Location:admin-orders-edit.php');
}
?>
...
while($row=mysqli_fetch_assoc($result))
  ...
  echo "<td style='padding:20px;'>" . $row['Nust_Id'] . "</td>";
...
<form class="form-horizontal" action="" method="post"  id="admin_sign_out_form">
    <fieldset>    
          ...
          <a href="admin-cafe-edit.php"><button style="margin-top: 5%;" type="submit" name="orders_edit_direct" class="btn btn-danger" >Edit Data</button></a>
