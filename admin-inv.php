...
?>
<?php  
if(isset($_POST["inv_edit_direct"])){
  header('Location:admin-inv-edit.php');
}
?>
...
<head>
    ...
    <title>Admin Page-Inventory</title>
...
echo "<h2 style='margin-left:25%;margin-bottom:10%; color:white'>Inventory</h2>";
...
<th style='padding:20px;'>Cafe</th>
</tr>";
while($row=mysqli_fetch_assoc($result))
  {
  echo "<tr>";
  echo "<td style='padding:20px;'>" . $row['Product_ID'] . "</td>";
  echo "<td style='padding:20px;'>" . $row['Name'] . "</td>";
  echo "<td style='padding:20px;'>" . $row['Price'] . "</td>";
  echo "<td style='padding:20px;'>" . $row['Cafe'] . "</td>";
  echo "</tr>";
  }
echo "</table>";
...
<form class="form-horizontal" action="" method="post"  id="admin_sign_out_form">
    <fieldset>    
            <div class="form-group">
              <a href="admin-cafe-edit.php"><button style="margin-top: 5%;" type="submit" name="inv_edit_direct" class="btn btn-danger" >Edit Data</button></a>
