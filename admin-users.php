...
?>
<?php  
if(isset($_POST["users_edit_direct"])){
...
<div class="container">
  <div class="demo-1">
  <h1 style="color:white; font-size: 60px; margin-top: 5%; "><center>Admin Panel</center></h1>
  </div>
</div>
...
<span style="font-size:30px;color:white;cursor:pointer" id="ops" onclick="openNav()">Operations  &#9776;</span>
...
echo "<h2 style='margin-left:38%;margin-bottom:10%; color:white'>User Details</h2>";
...
while($row=mysqli_fetch_assoc($result))
  ...
  echo "<td style='padding:20px;'>" . $row['FName'] . "</td>";
  echo "<td style='padding:20px;'>" . $row['LName'] . "</td>";
  echo "<td style='padding:20px;'>" . $row['Email'] . "</td>";
  echo "<td style='padding:20px;'>" . $row['password'] . "</td>";
  echo "<td style='padding:20px;'>" . $row['Phone'] . "</td>";
  echo "<td style='padding:20px;'>" . $row['Address'] . "</td>";
...
<form class="form-horizontal" action="" method="post"  id="admin_sign_out_form">
    <fieldset>    
            ...
            <a href="admin-cafe-edit.php"><button style="margin-top: 5%;" type="submit" name="users_edit_direct" class="btn btn-danger" >Edit Data</button></a>
